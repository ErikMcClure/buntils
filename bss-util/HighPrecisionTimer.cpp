...
HighPrecisionTimer::HighPrecisionTimer(const HighPrecisionTimer& copy) : _time(copy._time), _delta(copy._delta), _curTime(copy._curTime), _nsTime(copy._nsTime), _nsDelta(copy._nsDelta)
{}
