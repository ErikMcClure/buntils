...
#ifndef __BSS_STACK_H__
#define __BSS_STACK_H__
...
namespace bss {
  ...
  template<class T, typename CType = uint32_t, ARRAY_TYPE ArrayType = ARRAY_SIMPLE, typename Alloc = StaticAllocPolicy<T>>
