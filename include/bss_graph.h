...
namespace bss_util {
  ...
  protected:
    ...
    ST _nedges;
    cLinkedArray<Node<E,V,ST>,ST,ARRAYTYPE> _nodes;
  };
  ...
  template<typename E, typename V, typename ST, typename ALLOC, typename ARRAYTYPE>
  static void MaxFlow_PushRelabel(Graph<__edge_MaxFlow<E>,V,ST,ALLOC,ARRAYTYPE>& graph, ST s, ST t)
  {
  ...
  template<typename E, typename V, typename ST, typename ALLOC, typename ARRAYTYPE>
  static int Circulation_MaxFlow(Graph<__edge_MaxFlow<E>,__vertex_Demand<V>,ST,ALLOC,ARRAYTYPE>& g, ST& s, ST& t)
  {
  ...
  template<typename E, typename V, typename ST, typename ALLOC, typename ARRAYTYPE>
  static void LowerBound_Circulation(Graph<__edge_MaxFlow<__edge_LowerBound<E>>,__vertex_Demand<V>,ST,ALLOC,ARRAYTYPE>& g)
  {
