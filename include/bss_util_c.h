...
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF8toUTF16(const char*BSS_RESTRICT input, long srclen, wchar_t*BSS_RESTRICT output, size_t buflen);
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF16toUTF8(const wchar_t*BSS_RESTRICT input, long srclen, char*BSS_RESTRICT output, size_t buflen);
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF8toUTF32(const char*BSS_RESTRICT input, long srclen, int*BSS_RESTRICT output, size_t buflen);
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF32toUTF8(const int*BSS_RESTRICT input, long srclen, char*BSS_RESTRICT output, size_t buflen);
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF32toUTF16(const int*BSS_RESTRICT input, long srclen, wchar_t*BSS_RESTRICT output, size_t buflen);
BSS_COMPILER_DLLEXPORT extern size_t BSS_FASTCALL UTF16toUTF32(const wchar_t*BSS_RESTRICT input, long srclen, int*BSS_RESTRICT output, size_t buflen);
