...
#ifndef __BITFIELD_H__BUN__ // These are used in case this header file is used by two different projects dependent on each
...
namespace bun {
  namespace internal {
    ...
    template<typename U> class BUN_COMPILER_DLLEXPORT _BIT_ITER
    {
    ...
    public:
      ...
      inline _BIT_ITER& operator++()
      {
        _incthis();
        return *this;
      } // prefix
      inline _BIT_ITER operator++(int)
      {
        _BIT_ITER r(*this);
        ++*this;
        return r;
  ...
  public:
    ...
    inline BitField& operator=(T right)
    {
      _bits = right;
      return *this;
    }
    ...
    inline BitField& operator+=(T bit)
    {
      _bits |= bit;
      return *this;
    }
