...
namespace bun {
  ...
  struct BUN_DLLEXPORT INIentry
  {
    ...
    BUN_FORCEINLINE operator char() const { return (char)_ivalue; }
    BUN_FORCEINLINE operator short() const { return (short)_ivalue; }
    BUN_FORCEINLINE operator int() const { return (int)_ivalue; }
    BUN_FORCEINLINE operator int64_t() const { return (int64_t)_ivalue; }
    BUN_FORCEINLINE operator uint8_t() const { return (uint8_t)_ivalue; }
    BUN_FORCEINLINE operator uint16_t() const { return (uint16_t)_ivalue; }
    BUN_FORCEINLINE operator uint32_t() const { return (uint32_t)_ivalue; }
    BUN_FORCEINLINE operator uint64_t() const { return (uint64_t)_ivalue; }
    BUN_FORCEINLINE operator float() const { return (float)_dvalue; }
