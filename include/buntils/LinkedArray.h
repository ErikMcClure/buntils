...
namespace bun {
  namespace internal {
    ...
    struct BUN_COMPILER_DLLEXPORT LINKEDNODE
    {
      T val;
      CType next;
      CType prev;
  ...
  public:
    ...
    inline LinkedArray(CT_ size, const Alloc& alloc) : _ref(size, alloc), _length(0), _start(-1), _end(-1), _freelist(-1) { _setupChunk(0); }
    ...
    public:
      ...
      BUN_FORCEINLINE U* operator->() const { return &_src[cur]; }
      BUN_FORCEINLINE cLAIter& operator++() { _src.Next(cur); return *this; } //prefix
      BUN_FORCEINLINE cLAIter operator++(int) { cLAIter r = *this; ++*this; return r; } //postfix
      BUN_FORCEINLINE cLAIter& operator--() { _src.Prev(cur); return *this; } //prefix
      BUN_FORCEINLINE cLAIter operator--(int) { cLAIter r = *this; --*this; return r; } //postfix
