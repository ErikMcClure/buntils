...
// #endif
  ...
  #define BUN_32BIT
#else
  #define BUN_CPU_UNKNOWN // Unknown CPU architecture (should force architecture independent C implementations for all
                          // utilities)
#endif
...
#if !(defined(BUN_PLATFORM_WIN32) || defined(BUN_PLATFORM_POSIX) || defined(BUN_PLATFORM_WIN32_CE) || \
      defined(BUN_PLATFORM_APPLE))
  #error "Unknown Platform"
#endif

// Endianness detection
#if defined(BUN_PLATFORM_WIN32) || defined(BUN_PLATFORM_WIN32_CE) || defined(BUN_CPU_x86_64) || defined(BUN_CPU_x86) || \
  defined(BUN_CPU_IA_64) // Windows, x86, x86_64 and itanium all only run in little-endian (except on HP-UX but we don't
                         // support that)
