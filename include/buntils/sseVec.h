...
namespace bun {
  ...
  {
    std::array<T, 2> r;
    r[0] = a[i != 0]; // According to the SSE docs, the instruction treats all nonzero numbers as one, even though the
                      // immediate integer has two bits reserved for each index.
    r[1] = b[(i >> 2) != 0];
    return r;
  }
  ...
  template<class T, size_t O> BUN_FORCEINLINE std::array<T, 8> _sse_array_shuffle8(const std::array<T, 8>& a, int i)
  {
    std::array<T, 8> r(a);
    r[0 + O] = a[(i & 3) + O];
    r[1 + O] = a[((i >> 2) & 3) + O];
  ...
  template<class T, int I, T (*F)(T)> BUN_FORCEINLINE std::array<T, I> _sse_array_unaryop(const std::array<T, I>& a)
  {
    std::array<T, I> r;
    for(size_t i = 0; i < I; ++i)
      r[i] = F(a[i]);
  ...
  template<class T, bool (*F)(T, T)> BUN_FORCEINLINE T _sse_array_cmp(T l, T r)
  {
    typename bun::TBitLimit<T>::UNSIGNED t = (F(l, r) ? ((typename bun::TBitLimit<T>::UNSIGNED) ~0) : 0);
    return *(T*)&t;
  }
  ...
  #define BUN_SSE_LOAD_APS(x) \
    BUN_SSE_M128 { (x)[0], (x)[1], (x)[2], (x)[3] }
  #define BUN_SSE_LOAD_UPS BUN_SSE_LOAD_APS
  #define BUN_SSE_SET_PS(a, b, c, d) \
    BUN_SSE_M128 { d, c, b, a }
  #define BUN_SSE_SET1_PS(a) \
    BUN_SSE_M128 { a, a, a, a }
  #define BUN_SSE_STORE_APS(v, a) \
    (v)[0] = (a)[0];              \
    (v)[1] = (a)[1];              \
    (v)[2] = (a)[2];              \
    (v)[3] = (a)[3]
  ...
  BUN_FORCEINLINE BUN_SSE_M128 BUN_SSE_MOVEHL_PS(BUN_SSE_M128 a, BUN_SSE_M128 b)
  {
    return BUN_SSE_M128{ (b)[2], (b)[3], (a)[2], (a)[3] };
  }
  BUN_FORCEINLINE BUN_SSE_M128 BUN_SSE_MOVELH_PS(BUN_SSE_M128 a, BUN_SSE_M128 b)
  {
    return BUN_SSE_M128{ (a)[0], (a)[1], (b)[0], (b)[1] };
  }
  ...
  #define BUN_SSE_LOAD_APD(x) \
    BUN_SSE_M128d { (x)[0], (x)[1] }
  #define BUN_SSE_LOAD_UPD BUN_SSE_LOAD_APD
  #define BUN_SSE_SET_PD(x, y) \
    BUN_SSE_M128d { y, x }
  #define BUN_SSE_SET1_PD(x) \
    BUN_SSE_M128d { x, x }
  #define BUN_SSE_STORE_APD(v, a) \
    (v)[0] = (a)[0];              \
    (v)[1] = (a)[1];
  ...
  #define BUN_SSE_SET_EPI32(a, b, c, d) \
    BUN_SSE_M128i { d, c, b, a }
  #define BUN_SSE_SET1_EPI32(a) \
    BUN_SSE_M128i { a, a, a, a }
  ...
  #define BUN_SSE_SET_EPI8(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) \
    BUN_SSE_M128i8 { p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a }
  #define BUN_SSE_SET1_EPI8(a) \
    BUN_SSE_M128i8 { a, a, a, a, a, a, a, a, a, a, a, a, a, a, a, a }
  ...
  #define BUN_SSE_SET_EPI16(a, b, c, d, e, f, g, h) \
    BUN_SSE_M128i16 { h, g, f, e, d, c, b, a }
  #define BUN_SSE_SET1_EPI16(a) \
    BUN_SSE_M128i16 { a, a, a, a, a, a, a, a }
  ...
  #define BUN_SSE_SET_EPI64(a, b) \
    BUN_SSE_M128i64 { b, a }
  #define BUN_SSE_SET1_EPI64(a) \
    BUN_SSE_M128i64 { a, a }
  ...
  #define BUN_SSE_PS_EPI32 \
    _sse_array_cvt<float, 4, int32_t, 4> // This should convert using rounding but there is no easy way to do this if SSE
                                         // instructions aren't available, so we just don't.
  ...
  BUN_FORCEINLINE __m128i BUN_SSE_SET_EPI64(int64_t y, int64_t x)
  {
    BUN_ALIGN(16) int64_t vv[2] = { x, y };
    return BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)vv);
  }
...
#define BUN_SSE_SHUFFLE(x, y, z, w) ((w << 6) | (z << 4) | (y << 2) | x)
  ...
  template<typename T> struct BUN_UNALIGNED
  {
  ...
  template<> struct alignas(16) sseVecT<float>
  {
    ...
    BUN_FORCEINLINE sseVecT<float> operator+(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_ADD_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator-(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_SUB_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator*(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_MUL_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator/(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_DIV_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float>& operator+=(const sseVecT<float>& r)
    {
      xmm = BUN_SSE_ADD_PS(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator-=(const sseVecT<float>& r)
    {
      xmm = BUN_SSE_SUB_PS(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator*=(const sseVecT<float>& r)
    {
      xmm = BUN_SSE_MUL_PS(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator/=(const sseVecT<float>& r)
    {
      xmm = BUN_SSE_DIV_PS(xmm, r.xmm);
      return *this;
    }
    ...
    BUN_FORCEINLINE void Set(float (&v)[4]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_APS(v, xmm);
    }
    ...
    BUN_FORCEINLINE sseVecT<float>& operator=(BUN_SSE_M128 v)
    {
      xmm = v;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator=(float v)
    {
      xmm = BUN_SSE_SET1_PS(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator=(const float (&v)[4])
    {
      xmm = BUN_SSE_LOAD_APS(v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<float>& operator=(BUN_UNALIGNED<const float> v)
    {
      xmm = BUN_SSE_LOAD_UPS(v._p);
      return *this;
    }
    ...
    BUN_FORCEINLINE sseVecT<float> operator==(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPEQ_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator!=(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPNEQ_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator<(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPLT_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator<=(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPLTE_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator>(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPGT_PS(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<float> operator>=(const sseVecT<float>& r) const
    {
      return sseVecT<float>(BUN_SSE_CMPGTE_PS(xmm, r.xmm));
    }
    template<int x, int y, int z, int w> BUN_FORCEINLINE sseVecT<float> Shuffle() const
    {
      return Shuffle<BUN_SSE_SHUFFLE(x, y, z, w)>(*this);
    }
    template<int Positions> static sseVecT<float> Shuffle(const sseVecT<float>& x)
    {
      return BUN_SSE_CAST_SI128_PS(BUN_SSE_SHUFFLE_EPI32(BUN_SSE_CAST_PS_SI128(x), Positions));
    }
    static sseVecT<float> ZeroVector() { return sseVecT<float>(BUN_SSE_SETZERO_PS()); }
    BUN_FORCEINLINE float Sum() const
    {
      sseVecT<float> x = BUN_SSE_ADD_PS(xmm, Shuffle<1, 0, 3, 2>());
      return BUN_SSE_SS_F32(BUN_SSE_ADD_PS(x, x.Shuffle<2, 3, 0, 1>()));
    }
  ...
  template<> struct alignas(16) sseVecT<double>
  {
    ...
    BUN_FORCEINLINE sseVecT<double> operator+(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_ADD_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator-(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_SUB_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator*(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_MUL_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator/(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_DIV_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double>& operator+=(const sseVecT<double>& r)
    {
      xmm = BUN_SSE_ADD_PD(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator-=(const sseVecT<double>& r)
    {
      xmm = BUN_SSE_SUB_PD(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator*=(const sseVecT<double>& r)
    {
      xmm = BUN_SSE_MUL_PD(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator/=(const sseVecT<double>& r)
    {
      xmm = BUN_SSE_DIV_PD(xmm, r.xmm);
      return *this;
    }
    ...
    BUN_FORCEINLINE void Set(double (&v)[2]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_APD(v, xmm);
    }
    ...
    BUN_FORCEINLINE sseVecT<double>& operator=(BUN_SSE_M128d v)
    {
      xmm = v;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator=(double v)
    {
      xmm = BUN_SSE_SET1_PD(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator=(const double (&v)[2])
    {
      xmm = BUN_SSE_LOAD_APD(v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<double>& operator=(BUN_UNALIGNED<const double> v)
    {
      xmm = BUN_SSE_LOAD_UPD(v._p);
      return *this;
    }

    BUN_FORCEINLINE sseVecT<double> min(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_MIN_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> max(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_MAX_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator==(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPEQ_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator!=(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPNEQ_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator<(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPLT_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator<=(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPLTE_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator>(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPGT_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> operator>=(const sseVecT<double>& r) const
    {
      return sseVecT<double>(BUN_SSE_CMPGTE_PD(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<double> Swap() const { return BUN_SSE_SHUFFLE_PD(xmm, xmm, 1); }

    template<int Positions> static sseVecT<double> Shuffle(const sseVecT<double>& x)
    {
      return BUN_SSE_CAST_SI128_PD(BUN_SSE_SHUFFLE_EPI32(BUN_SSE_CAST_PD_SI128(x), Positions));
    }
  ...
  template<> struct alignas(16) sseVecT<char>
  {
#ifndef BUN_SSE_ENABLED
    BUN_FORCEINLINE sseVecT(bun_si128 v) : xmm(v) {}
#endif
    BUN_FORCEINLINE sseVecT(BUN_SSE_M128i8 v) :
      xmm(v) {} //__fastcall is obviously useless here since we're dealing with xmm registers
    BUN_FORCEINLINE sseVecT(char v) : xmm(BUN_SSE_SET1_EPI8(v)) {}
    BUN_FORCEINLINE explicit sseVecT(const char (&v)[16]) : xmm(BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v))
    {
      assert(!(((size_t)v) % 16));
    }
    ...
    BUN_FORCEINLINE sseVecT(char b1, char b2, char b3, char b4, char b5, char b6, char b7, char b8, char b9, char b10,
                            char b11, char b12, char b13, char b14, char b15,
                            char b16) : // This is the craziest constructor definition ever
      xmm(BUN_SSE_SET_EPI8(b16, b15, b14, b13, b12, b11, b10, b9, b8, b7, b6, b5, b4, b3, b2, b1))
    {}
    BUN_FORCEINLINE sseVecT<char> operator+(const sseVecT<char>& r) const
    {
      return sseVecT<char>(BUN_SSE_ADD_EPI8(xmm, r.xmm));
    } // These don't return const sseVecT<char> because it makes things messy.
    BUN_FORCEINLINE sseVecT<char> operator-(const sseVecT<char>& r) const
    {
      return sseVecT<char>(BUN_SSE_SUB_EPI8(xmm, r.xmm));
    }
    ...
    BUN_FORCEINLINE sseVecT<char>& operator+=(const sseVecT<char>& r)
    {
      xmm = BUN_SSE_ADD_EPI8(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator-=(const sseVecT<char>& r)
    {
      xmm = BUN_SSE_SUB_EPI8(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator&=(const sseVecT<char>& r)
    {
      xmm = BUN_SSE_AND(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator|=(const sseVecT<char>& r)
    {
      xmm = BUN_SSE_OR(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator^=(const sseVecT<char>& r)
    {
      xmm = BUN_SSE_XOR(xmm, r.xmm);
      return *this;
    }
    ...
    BUN_FORCEINLINE sseVecT<char> operator==(const sseVecT<char>& r) const
    {
      return sseVecT<char>(BUN_SSE_CMPEQ_EPI8(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<char> operator!=(const sseVecT<char>& r) const { return !operator==(r); }
    BUN_FORCEINLINE sseVecT<char> operator<(const sseVecT<char>& r) const
    {
      return sseVecT<char>(BUN_SSE_CMPLT_EPI8(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<char> operator<=(const sseVecT<char>& r) const { return !operator>(r); }
    BUN_FORCEINLINE sseVecT<char> operator>(const sseVecT<char>& r) const
    {
      return sseVecT<char>(BUN_SSE_CMPGT_EPI8(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<char> operator>=(const sseVecT<char>& r) const { return !operator<(r); }
    ...
    BUN_FORCEINLINE sseVecT<char>& operator=(BUN_SSE_M128i8 r)
    {
      xmm = r;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator=(char v)
    {
      xmm = BUN_SSE_SET1_EPI8(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator=(const char (&v)[16])
    {
      xmm = BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<char>& operator=(BUN_UNALIGNED<const char> v)
    {
      xmm = BUN_SSE_LOAD_USI128((BUN_SSE_M128i*)v._p);
      return *this;
    }

    BUN_FORCEINLINE void Set(char (&v)[16]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)v, xmm);
    }
    ...
    template<int Positions> static sseVecT<char> Shuffle(const sseVecT<char>& x)
    {
      return BUN_SSE_SHUFFLE_EPI32(x, Positions);
    }
    template<int Positions> static sseVecT<char> ShuffleHi(const sseVecT<char>& x)
    {
      return BUN_SSE_SHUFFLEHI_EPI16(x, Positions);
    }
    template<int Positions> static sseVecT<char> ShuffleLo(const sseVecT<char>& x)
    {
      return BUN_SSE_SHUFFLELO_EPI16(x, Positions);
    }
  ...
  template<> struct alignas(16) sseVecT<int16_t>
  {
    BUN_FORCEINLINE sseVecT(BUN_SSE_M128i16 v) :
      xmm(v) {} //__fastcall is obviously useless here since we're dealing with xmm registers
    ...
    BUN_FORCEINLINE explicit sseVecT(const int16_t (&v)[8]) : xmm(BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v))
    {
      assert(!(((size_t)v) % 16));
    }
    BUN_FORCEINLINE explicit sseVecT(BUN_UNALIGNED<const int16_t> v) : xmm(BUN_SSE_LOAD_USI128((BUN_SSE_M128i*)v._p)) {}
    BUN_FORCEINLINE sseVecT(int16_t s, int16_t t, int16_t u, int16_t v, int16_t w, int16_t x, int16_t y, int16_t z) :
      xmm(BUN_SSE_SET_EPI16(z, y, x, w, v, u, t, s))
    {}
    BUN_FORCEINLINE sseVecT<int16_t> operator+(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_ADD_EPI16(xmm, r.xmm));
    } // These don't return const sseVecT<int16_t> because it makes things messy.
    BUN_FORCEINLINE sseVecT<int16_t> operator-(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_SUB_EPI16(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator&(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_AND(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator|(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_OR(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator^(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_XOR(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator>>(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_SR_EPI16(xmm, r.xmm));
    } // Amazingly enough this does not conflict with the extraction operator
    BUN_FORCEINLINE sseVecT<int16_t> operator>>(int r) const { return sseVecT<int16_t>(BUN_SSE_SRI_EPI16(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int16_t> operator<<(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_SL_EPI16(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator<<(int r) const { return sseVecT<int16_t>(BUN_SSE_SLI_EPI16(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int16_t>& operator+=(const sseVecT<int16_t>& r)
    {
      xmm = BUN_SSE_ADD_EPI16(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator-=(const sseVecT<int16_t>& r)
    {
      xmm = BUN_SSE_SUB_EPI16(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator&=(const sseVecT<int16_t>& r)
    {
    ...
    BUN_FORCEINLINE sseVecT<int16_t>& operator>>=(const sseVecT<int16_t>& r)
    {
      xmm = BUN_SSE_SR_EPI16(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator>>=(int r)
    {
      xmm = BUN_SSE_SRI_EPI16(xmm, r);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator<<=(const sseVecT<int16_t>& r)
    {
      xmm = BUN_SSE_SL_EPI16(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator<<=(int r)
    {
      xmm = BUN_SSE_SLI_EPI16(xmm, r);
      return *this;
    }
    ...
    BUN_FORCEINLINE sseVecT<int16_t> operator==(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_CMPEQ_EPI16(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator!=(const sseVecT<int16_t>& r) const { return !operator==(r); }
    BUN_FORCEINLINE sseVecT<int16_t> operator<(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_CMPLT_EPI16(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator<=(const sseVecT<int16_t>& r) const { return !operator>(r); }
    BUN_FORCEINLINE sseVecT<int16_t> operator>(const sseVecT<int16_t>& r) const
    {
      return sseVecT<int16_t>(BUN_SSE_CMPGT_EPI16(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator>=(const sseVecT<int16_t>& r) const { return !operator<(r); }
    BUN_FORCEINLINE sseVecT<int16_t> operator~() const
    {
      return sseVecT<int16_t>(BUN_SSE_XOR(xmm, BUN_SSE_SET1_EPI16(-1)));
    }
    BUN_FORCEINLINE sseVecT<int16_t> operator!() const { return sseVecT<int16_t>(BUN_SSE_CMPEQ_EPI16(xmm, ZeroVector())); }
    BUN_FORCEINLINE sseVecT<int16_t>& operator=(BUN_SSE_M128i16 r)
    {
      xmm = r;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator=(int16_t v)
    {
      xmm = BUN_SSE_SET1_EPI16(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator=(const int16_t (&v)[8])
    {
      xmm = BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int16_t>& operator=(BUN_UNALIGNED<const int16_t> v)
    {
      xmm = BUN_SSE_LOAD_USI128((BUN_SSE_M128i*)v._p);
      return *this;
    }

    BUN_FORCEINLINE void Set(int16_t (&v)[8]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)v, xmm);
    }
    ...
    template<int Positions> static sseVecT<int16_t> Shuffle(const sseVecT<int16_t>& x)
    {
      return BUN_SSE_SHUFFLE_EPI32(x, Positions);
    }
    template<int Positions> static sseVecT<int16_t> ShuffleHi(const sseVecT<int16_t>& x)
    {
      return BUN_SSE_SHUFFLEHI_EPI16(x, Positions);
    }
    template<int Positions> static sseVecT<int16_t> ShuffleLo(const sseVecT<int16_t>& x)
    {
      return BUN_SSE_SHUFFLELO_EPI16(x, Positions);
    }
  ...
  template<> struct alignas(16) sseVecT<int32_t>
  {
    BUN_FORCEINLINE sseVecT(BUN_SSE_M128i v) :
      xmm(v) {} //__fastcall is obviously useless here since we're dealing with xmm registers
    ...
    BUN_FORCEINLINE explicit sseVecT(const int (&v)[4]) : xmm(BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v))
    {
      assert(!(((size_t)v) % 16));
    }
    ...
    BUN_FORCEINLINE sseVecT<int> operator+(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_ADD_EPI32(xmm, r.xmm));
    } // These don't return const sseVecT<int> because it makes things messy.
    BUN_FORCEINLINE sseVecT<int> operator-(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_SUB_EPI32(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int> operator*(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_MUL_EPI32(xmm, r.xmm));
    }
    ...
    BUN_FORCEINLINE sseVecT<int> operator>>(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_SAR_EPI32(xmm, r.xmm));
    } // Amazingly enough this does not conflict with the extraction operator
    BUN_FORCEINLINE sseVecT<int> operator>>(int r) const { return sseVecT<int>(BUN_SSE_SARI_EPI32(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int> operator<<(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_SL_EPI32(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int> operator<<(int r) const { return sseVecT<int>(BUN_SSE_SLI_EPI32(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int>& operator+=(const sseVecT<int>& r)
    {
      xmm = BUN_SSE_ADD_EPI32(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator-=(const sseVecT<int>& r)
    {
      xmm = BUN_SSE_SUB_EPI32(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator*=(const sseVecT<int>& r)
    {
      xmm = BUN_SSE_MUL_EPI32(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator&=(const sseVecT<int>& r)
    {
    ...
    BUN_FORCEINLINE sseVecT<int>& operator>>=(const sseVecT<int>& r)
    {
      xmm = BUN_SSE_SAR_EPI32(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator>>=(int r)
    {
      xmm = BUN_SSE_SARI_EPI32(xmm, r);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator<<=(const sseVecT<int>& r)
    {
      xmm = BUN_SSE_SL_EPI32(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator<<=(int r)
    {
      xmm = BUN_SSE_SLI_EPI32(xmm, r);
      return *this;
    }
    ...
    BUN_FORCEINLINE sseVecT<int> operator==(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_CMPEQ_EPI32(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int> operator!=(const sseVecT<int>& r) const { return !operator==(r); }
    BUN_FORCEINLINE sseVecT<int> operator<(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_CMPLT_EPI32(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int> operator<=(const sseVecT<int>& r) const { return !operator>(r); }
    BUN_FORCEINLINE sseVecT<int> operator>(const sseVecT<int>& r) const
    {
      return sseVecT<int>(BUN_SSE_CMPGT_EPI32(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int> operator>=(const sseVecT<int>& r) const { return !operator<(r); }
    ...
    BUN_FORCEINLINE sseVecT<int>& operator=(BUN_SSE_M128i r)
    {
      xmm = r;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator=(BUN_SSE_M128 r)
    {
      xmm = BUN_SSE_TPS_EPI32(r);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator=(int v)
    {
      xmm = BUN_SSE_SET1_EPI32(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator=(const int (&v)[4])
    {
      xmm = BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int>& operator=(BUN_UNALIGNED<const int> v)
    {
      xmm = BUN_SSE_LOAD_USI128((BUN_SSE_M128i*)v._p);
      return *this;
    }
    ...
    BUN_FORCEINLINE void Set(int (&v)[4]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)v, xmm);
    }
    ...
    template<int x, int y, int z, int w> BUN_FORCEINLINE sseVecT<int> Shuffle() const
    {
      return Shuffle<BUN_SSE_SHUFFLE(x, y, z, w)>(*this);
    }
    BUN_FORCEINLINE int Sum() const
    {
      sseVecT<int> x = BUN_SSE_ADD_EPI32(xmm, Shuffle<1, 0, 3, 2>());
      return BUN_SSE_SI128_SI32(BUN_SSE_ADD_EPI32(x, x.Shuffle<2, 3, 0, 1>()));
    }

    template<int Positions> static sseVecT<int> Shuffle(const sseVecT<int>& x)
    {
      return sseVecT<int>(BUN_SSE_SHUFFLE_EPI32(x.xmm, Positions));
    }
    template<int Positions> static sseVecT<int> ShuffleHi(const sseVecT<int>& x)
    {
      return sseVecT<int>(BUN_SSE_SHUFFLEHI_EPI16(x.xmm, Positions));
    }
    template<int Positions> static sseVecT<int> ShuffleLo(const sseVecT<int>& x)
    {
      return sseVecT<int>(BUN_SSE_SHUFFLELO_EPI16(x.xmm, Positions));
    }
  ...
  template<> struct alignas(16) sseVecT<int64_t>
  {
    BUN_FORCEINLINE sseVecT(BUN_SSE_M128i64 v) :
      xmm(v) {} //__fastcall is obviously useless here since we're dealing with xmm registers
    BUN_FORCEINLINE sseVecT(int64_t v) : xmm(BUN_SSE_SET1_EPI64(v)) {}
    BUN_FORCEINLINE explicit sseVecT(const int64_t (&v)[2]) : xmm(BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v))
    {
      assert(!(((size_t)v) % 16));
    }
    ...
    BUN_FORCEINLINE sseVecT<int64_t> operator+(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_ADD_EPI64(xmm, r.xmm));
    } // These don't return const sseVecT<int64_t> because it makes things messy.
    BUN_FORCEINLINE sseVecT<int64_t> operator-(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_SUB_EPI64(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int64_t> operator&(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_AND(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int64_t> operator|(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_OR(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int64_t> operator^(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_XOR(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int64_t> operator>>(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_SR_EPI64(xmm, r.xmm));
    } // Amazingly enough this does not conflict with the extraction operator
    BUN_FORCEINLINE sseVecT<int64_t> operator>>(int r) const { return sseVecT<int64_t>(BUN_SSE_SRI_EPI64(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int64_t> operator<<(const sseVecT<int64_t>& r) const
    {
      return sseVecT<int64_t>(BUN_SSE_SL_EPI64(xmm, r.xmm));
    }
    BUN_FORCEINLINE sseVecT<int64_t> operator<<(int r) const { return sseVecT<int64_t>(BUN_SSE_SLI_EPI64(xmm, r)); }
    BUN_FORCEINLINE sseVecT<int64_t>& operator+=(const sseVecT<int64_t>& r)
    {
      xmm = BUN_SSE_ADD_EPI64(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator-=(const sseVecT<int64_t>& r)
    {
      xmm = BUN_SSE_SUB_EPI64(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator&=(const sseVecT<int64_t>& r)
    {
    ...
    BUN_FORCEINLINE sseVecT<int64_t>& operator>>=(const sseVecT<int64_t>& r)
    {
      xmm = BUN_SSE_SR_EPI64(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator>>=(int r)
    {
      xmm = BUN_SSE_SRI_EPI64(xmm, r);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator<<=(const sseVecT<int64_t>& r)
    {
      xmm = BUN_SSE_SL_EPI64(xmm, r.xmm);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator<<=(int r)
    {
      xmm = BUN_SSE_SLI_EPI64(xmm, r);
      return *this;
    }
    ...
    BUN_FORCEINLINE sseVecT<int64_t> operator~() const
    {
      return sseVecT<int64_t>(BUN_SSE_XOR(xmm, BUN_SSE_SET1_EPI64(-1)));
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator=(BUN_SSE_M128i64 r)
    {
      xmm = r;
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator=(int64_t v)
    {
      xmm = BUN_SSE_SET1_EPI64(v);
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator=(const int64_t (&v)[2])
    {
      xmm = BUN_SSE_LOAD_ASI128((BUN_SSE_M128i*)v);
      assert(!(((size_t)v) % 16));
      return *this;
    }
    BUN_FORCEINLINE sseVecT<int64_t>& operator=(BUN_UNALIGNED<const int64_t> v)
    {
      xmm = BUN_SSE_LOAD_USI128((BUN_SSE_M128i*)v._p);
      return *this;
    }
    BUN_FORCEINLINE void Set(int64_t (&v)[2]) const
    {
      assert(!(((size_t)v) % 16));
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)v, xmm);
    }
...
#else
    BUN_FORCEINLINE void Set(int64_t& v) const
    {
      BUN_ALIGN(16) int64_t store[2];
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)store, xmm);
      v = store[0];
    }
#endif
    BUN_FORCEINLINE int64_t Sum() const
    {
      BUN_SSE_M128i64 x = BUN_SSE_ADD_EPI64(xmm, Swap());
      BUN_ALIGN(16) int64_t store[2];
      BUN_SSE_STORE_ASI128((BUN_SSE_M128i*)store, x);
      return store[0];
    }
    BUN_FORCEINLINE sseVecT<int64_t> Swap() const
    {
      return (BUN_SSE_M128i64)BUN_SSE_SHUFFLE_EPI32(xmm, BUN_SSE_SHUFFLE(2, 3, 0, 1));
    }

    static sseVecT<int64_t> ZeroVector() { return sseVecT<int64_t>(BUN_SSE_SETZERO_SI128()); }
    template<int Positions> static sseVecT<int64_t> Shuffle(const sseVecT<int64_t>& x)
    {
      return BUN_SSE_SHUFFLE_EPI32(x, Positions);
    }
    template<int Positions> static sseVecT<int64_t> ShuffleHi(const sseVecT<int64_t>& x)
    {
      return BUN_SSE_SHUFFLEHI_EPI16(x, Positions);
    }
    template<int Positions> static sseVecT<int64_t> ShuffleLo(const sseVecT<int64_t>& x)
    {
      return BUN_SSE_SHUFFLELO_EPI16(x, Positions);
    }
