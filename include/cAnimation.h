...
namespace bss_util {
  ...
  struct cAniCubicEasing
  {
    ...
    static inline double GetProgress(const typename cAnimation<T, D>::FRAME* v, uint32_t l, uint32_t cur, double t)
    {
  ...
  {
    static inline T LinearInterpolate(const typename cAnimation<T, cAniLinearData<T>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      double s = GetProgress<T, cAniLinearData<T>>(v, l, cur, t);
      return lerp<T>(!cur ? init : v[cur - 1].value, v[cur].value, s);
    }
    static inline T LinearInterpolateRel(const typename cAnimation<T, cAniLinearData<T>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      assert(cur > 0);
      double s = GetProgress<T, cAniLinearData<T>>(v, l, cur, t);
  ...
  struct cAniQuadData : cAniCubicEasing
  {
    ...
    static inline T QuadraticInterpolateBase(const typename cAnimation<T, cAniQuadData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
    ...
    static inline T QuadraticInterpolate(const typename cAnimation<T, cAniQuadData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      return QuadraticInterpolateBase(v, l, cur, t, init);
    }
    static inline T QuadraticInterpolateRel(const typename cAnimation<T, cAniQuadData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      assert(cur > 0);
  ...
  struct cAniCubicData : cAniCubicEasing
  {
    ...
    static inline T CubicInterpolateBase(const typename cAnimation<T, cAniCubicData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
    ...
    static inline double CubicInterpolate(const typename cAnimation<T, cAniCubicData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      return CubicInterpolateBase(v, l, cur, t, init);
    }
    static inline double CubicInterpolateRel(const typename cAnimation<T, cAniCubicData<T, LENGTH>>::FRAME* v, uint32_t l, uint32_t cur, double t, const T& init)
    {
      assert(cur > 0);
