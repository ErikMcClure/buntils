...
public:
  ...
  inline const S* Get(unsigned int index) const { return _lines[index]; }

  inline const S* operator [](unsigned int index) const { return _lines[index]; } 
...
#pragma warning(disable:4251)
  std::vector<S*> _lines;
#pragma warning(pop)
  S* m_cmdline; // the command line string
