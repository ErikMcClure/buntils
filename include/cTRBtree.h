...
namespace bss_util {
  ...
  public:
    ...
    // Iteration functions
    inline LLIterator<const TRB_Node<Key,Data>> begin() const { return LLIterator<const TRB_Node<Key,Data>>(_root); }
    inline LLIterator<const TRB_Node<Key,Data>> end() const { return LLIterator<const TRB_Node<Key,Data>>(0); }
    inline LLIterator<TRB_Node<Key,Data>> begin() { return LLIterator<TRB_Node<Key,Data>>(_root); }
    inline LLIterator<TRB_Node<Key,Data>> end() { return LLIterator<TRB_Node<Key,Data>>(0); }
