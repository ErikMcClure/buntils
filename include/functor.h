...
namespace bss_util {
  ...
  struct __declspec(dllexport) Functor
  {
  ...
  struct __declspec(dllexport) Functor<R,T1,T2,void>
  {
    inline virtual ~Functor() {}
    inline virtual Functor* BSS_FASTCALL Clone() const=0;
  ...
  struct __declspec(dllexport) Functor<R,T1,void,void>
  {
    inline virtual ~Functor() {}
    inline virtual Functor* BSS_FASTCALL Clone() const=0;
  ...
  template<typename R>
  struct __declspec(dllexport) Functor<R,void,void,void>
  {
    inline virtual ~Functor() {}
    inline virtual Functor* BSS_FASTCALL Clone() const=0;
  ...
  struct __declspec(dllexport) FuncInst : Functor<R,T1,T2,T3>
  {
  ...
  struct __declspec(dllexport) FuncInst<T,R,T1,T2,void> : Functor<R,T1,T2,void>
  {
  ...
  struct __declspec(dllexport) FuncInst<T,R,T1,void,void> : Functor<R,T1,void,void>
  {
  ...
  struct __declspec(dllexport) FuncInst<T,R,void,void,void> : Functor<R,void,void,void>
  {
