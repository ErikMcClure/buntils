...
namespace bss_util {
  ...
  template<typename R>
  struct Functor<R,void,void,void>
  {
    inline virtual ~Functor() {}
    inline virtual Functor* BSS_FASTCALL Clone() const=0;
  ...
  struct FuncInst : Functor<R,T1,T2,T3>
  {
    FuncInst(T* source, R (BSS_FASTCALL T::*funcptr)(T1,T2,T3)) : _funcptr(funcptr), _source(source) {}
    virtual R BSS_FASTCALL Call(T1 t1, T2 t2, T3 t3) const { R (_source->*_funcptr)(t1,t2,t3); }
  ...
  struct FuncInst<T,R,T1,T2,void> : Functor<R,T1,T2,void>
  {
    FuncInst(T* source, R (BSS_FASTCALL T::*funcptr)(T1,T2)) : _funcptr(funcptr), _source(source) {}
    virtual R BSS_FASTCALL Call(T1 t1, T2 t2) const { R (_source->*_funcptr)(t1,t2); }
    inline virtual FuncInst* BSS_FASTCALL Clone() const { return new FuncInst(*this); }
  ...
  struct FuncInst<T,R,T1,void,void> : Functor<R,T1,void,void>
  {
    FuncInst(T* source, R (BSS_FASTCALL T::*funcptr)(T1)) : _funcptr(funcptr), _source(source) {}
    virtual R BSS_FASTCALL Call(T1 t1) const { R (_source->*_funcptr)(t1); }
    inline virtual FuncInst* BSS_FASTCALL Clone() const { return new FuncInst(*this); }
  ...
  struct FuncInst<T,R,void,void,void> : Functor<R,void,void,void>
  {
    FuncInst(T* source, R (BSS_FASTCALL T::*funcptr)(void)) : _funcptr(funcptr), _source(source) {}
    virtual R BSS_FASTCALL Call(void) const { R (_source->*_funcptr)(); }
    inline virtual FuncInst* BSS_FASTCALL Clone() const { return new FuncInst(*this); }

  protected:
    T* _source;
    R (BSS_FASTCALL T::*_funcptr)(void);
  };
}
#endif