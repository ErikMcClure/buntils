...
//-----------------------------------------------------------------------------
	...
	__declspec(dllexport) std::string OutputNodesAsString(const ProfileNode *a_root, uint32_t a_count);
	__declspec(dllexport) std::string OutputZonesAsString(const ProfileZone *a_root, uint32_t a_count);
