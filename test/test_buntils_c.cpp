...
{
  BEGINTEST;
  static_assert(sizeof(bun_VersionInfo) == sizeof(unsigned long long), "bun_VersionInfo is the wrong size!");
  bun_VersionInfo test = { 1, 2, 3, 4 };
  ...
  //    aaaa += bun_FMod<float>(-1.0f, testnums[i]+PIf);
  //  CPU_Barrier();
